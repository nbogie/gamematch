...
CREATE TABLE "players" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "bgg_username" text, "bgg_user_id" text, "meetup_username" text, "meetup_link" text, "meetup_status" text, "meetup_joined" text, "meetup_user_id" integer, "meetup_bio" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "collection_requested_at" datetime);
